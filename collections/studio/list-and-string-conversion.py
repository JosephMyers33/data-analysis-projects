...
for string in strings:
    if ";" in string:
        words_list = string.split(';')
        alpha_list = sorted(words_list)
        new_string = ",".join(alpha_list)
        print(new_string)
...
for string in strings:
    if " " in string:
        words_list = string.split(' ')
        space_list = reversed(sorted(words_list))
        new_string = " ".join(space_list)
        print(new_string)
...
for string in strings:
    if ", " in string:
        words_list = string.split(', ')
        comma_space_list = words_list[::-1]
        new_string = ", ".join(comma_space_list)
        print(new_string)